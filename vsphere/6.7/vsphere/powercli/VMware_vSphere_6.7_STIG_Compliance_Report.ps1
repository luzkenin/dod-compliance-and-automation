...
$V243078 = $false	#vCenter Server must provide alert of all audit failure events VCTR-67-000008
$V243079 = $false	#vCenter Server must implement Active Directory authentication VCTR-67-000009 
$V243080 = $false	#vCenter Server must limit the use of the built-in SSO administrative account VCTR-67-000010
$V243081 = $false	#vCenter Server must disable the distributed virtual switch health check VCTR-67-000012
$V243082 = $false	#vCenter Server must set the distributed port group Forged Transmits policy to reject VCTR-67-000013
$V243083 = $false	#vCenter Server must set the distributed port group MAC Address Change policy to reject VCTR-67-000014
$V243084 = $false	#vCenter Server must set the distributed port group Promiscuous Mode policy to reject VCTR-67-000015
$V243085 = $false	#vCenter Server must only send NetFlow traffic to authorized collectors VCTR-67-000016
$V243086 = $false	#vCenter Server must configure all port groups to a value other than that of the native VLAN VCTR-67-000018
$V243087 = $false	#vCenter Server must not configure VLAN Trunking unless Virtual Guest Tagging (VGT) is required and authorized VCTR-67-000019
$V243088 = $false	#vCenter Server must not configure all port groups to VLAN values reserved by upstream physical switches VCTR-67-000020
$V243089 = $false	#vCenter Server must configure the vpxuser auto-password to be changed every 30 days VCTR-67-000023
$V243090 = $false	#vCenter Server must configure the vpxuser password meets length policy VCTR-67-000024
$V243091 = $false	#vCenter Server must disable the managed object browser (MOB) at all times when not required for troubleshooting VCTR-67-000025
$V243092 = $false	#vCenter Server must check the privilege reassignment after restarts VCTR-67-000026
$V243093 = $false	#vCenter Server must enable all tasks to be shown to Administrators in the Web Client VCTR-67-000029
$V243094 = $false	#vCenter Server must restrict the connectivity between Update Manager and public patch repositories  VCTR-67-000031
$V243095 = $false	#vCenter Server must use a least-privileges assignment for the vCenter Server database user VCTR-67-000033
$V243096 = $false	#vCenter Server must use unique service accounts when applications connect to vCenter VCTR-67-000034
$V243097 = $false	#vCenter Server plugins must be verified VCTR-67-000035
$V243098 = $false	#vCenter Server must produce audit records containing information to establish what type of events occurred VCTR-67-000036
$V243099 = $false	#vCenter Server passwords must be at least 15 characters in length VCTR-67-000039
$V243100 = $false	#vCenter Server passwords must contain at least one uppercase character VCTR-67-000040
$V243101 = $false	#vCenter Server passwords must contain at least one lowercase character VCTR-67-000041
$V243102 = $false	#vCenter Server passwords must contain at least one numeric character VCTR-67-000042
$V243103 = $false	#vCenter Server passwords must contain at least one special character VCTR-67-000043
$V243104 = $false	#vCenter Server must limit the maximum number of failed login attempts to three VCTR-67-000045
$V243105 = $false	#vCenter Server must set the interval for counting failed login attempts to at least 15 minutes VCTR-67-000046
$V243106 = $false	#vCenter Server must require an administrator to unlock an account locked due to excessive login failures VCTR-67-000047
$V243107 = $false	#vCenter Server users must have the correct roles assigned VCTR-67-000051
$V243108 = $false	#vCenter Server must protect the confidentiality and integrity of transmitted information VCTR-67-000052
$V243109 = $false	#vCenter Server must enable the vSAN Health Check VCTR-67-000053
$V243110 = $false	#vCenter Server must disable or restrict the connectivity between vSAN Health Check and public Hardware Compatibility List VCTR-67-000054
$V243111 = $false	#vCenter Server must configure the vSAN Datastore name to a unique name VCTR-67-000055
$V243112 = $false	#vCenter Server must enable TLS 1.2 exclusively VCTR-67-000057
$V243113 = $false	#vCenter Server Machine SSL certificate must be issued by a DoD certificate authority VCTR-67-000058
$V243114 = $false	#vCenter Server must enable certificate based authentication VCTR-67-000059
$V243115 = $false	#vCenter Server must enable revocation checking for certificate-based authentication VCTR-67-000060
$V243116 = $false	#vCenter Server must disable Password and Windows integrated authentication VCTR-67-000061
$V243117 = $false	#vCenter Server must enable the login banner for vSphere Client VCTR-67-000062
$V243118 = $false	#vCenter Server must restrict access to the cryptographic role VCTR-67-000063
$V243119 = $false	#vCenter Server must restrict access to cryptographic permissions VCTR-67-000064
$V243120 = $false	#vCenter Server must have Mutual CHAP configured for vSAN iSCSI targets VCTR-67-000065
$V243121 = $false	#vCenter Server must have new Key Encryption Keys (KEKs) reissued at regular intervals VCTR-67-000066
$V243122 = $false	#vCenter Server must disable the Customer Experience Improvement Program (CEIP) VCTR-67-000067
$V243123 = $false	#vCenter Server must use secure Lightweight Directory Access Protocol (LDAPS) VCTR-67-000068
$V243124 = $false	#vCenter Server must use a limited privilege account when adding an LDAP identity source VCTR-67-000069
$V243125 = $false	#vCenter Server must not automatically refresh client sessions VCTR-67-000070
$V243126 = $false	#vCenter Server must terminate management sessions after 10 minutes of inactivity VCTR-67-000071
$V243127 = $false	#vCenter Server services must be ran using a service account instead of a built-in Windows account VCTR-67-000072
$V243128 = $false	#vCenter Server must minimize access to the vCenter server VCTR-67-000073
$V243129 = $false	#vCenter Server Administrators must clean up log files after failed installations VCTR-67-000074
$V243130 = $false	#vCenter Server must enable all tasks to be shown to Administrators in the Web Client VCTR-67-000075
$V243131 = $false	#vCenter Server Administrator role must be secured and assigned to specific users other than a Windows Administrator VCTR-67-000076
$V243132 = $false	#vCenter Server must enable TLS 1.2 exclusively VCTR-67-000077
$V243133 = $false	#vCenter Server must disable Password and Windows integrated authentication VCTR-67-000078
